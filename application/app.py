...
@app.route('/clustering/edge_betweenness', endpoint='clustering_edge_betweenness', methods=['GET', 'POST'])
...
@app.route('/clustering/k_clique', endpoint='clustering_k_clique', methods=['GET', 'POST'])
...
@app.route('/clustering/spectral', endpoint='clustering_spectral', methods=['GET', 'POST'])
...
@app.route('/clustering/kmeans', endpoint='clustering_kmeans', methods=['GET', 'POST'])
...
@app.route('/clustering/agglomerative', endpoint='clustering_agglomerative', methods=['GET', 'POST'])
...
@app.route('/clustering/dbscan', endpoint='clustering_dbscan', methods=['GET', 'POST'])
...
@app.route('/clustering/hierarchical', endpoint='clustering_hierarchical', methods=['GET', 'POST'])
