...
def centrality_degree():
    return process_single_metric('degree_centrality', 'centrality/centrality_degree.html', 'Degree Centrality', 'centrality_degree')

@centrality_routes.route('/centrality/eigenvector', endpoint='eigenvector', methods=['GET', 'POST'])
def centrality_eigenvector():
    return process_single_metric('eigenvector_centrality', 'centrality/centrality_eigenvector.html', 'Eigenvector Centrality', 'centrality_eigenvector')

@centrality_routes.route('/centrality/closeness', endpoint='closeness', methods=['GET', 'POST'])
def centrality_closeness():
    return process_single_metric('closeness_centrality', 'centrality/centrality_closeness.html', 'Closeness Centrality', 'centrality_closeness')

@centrality_routes.route('/centrality/betwenness', endpoint='betwenness', methods=['GET', 'POST'])
def centrality_betwenness():
    return process_single_metric('betweenness_centrality', 'centrality/centrality_betwenness.html', 'Betwenness Centrality', 'centrality_betwenness')

@centrality_routes.route('/centrality/load', endpoint='load', methods=['GET', 'POST'])
def centrality_load():
    return process_single_metric('load_centrality', 'centrality/centrality_load.html', 'Load Centrality', 'centrality_load')    