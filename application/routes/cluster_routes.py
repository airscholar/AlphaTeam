...
def clustering_greedy_modularity():
    ...
    return render_template('cluster/clustering_greedy_modularity.html', example=df, number_of_clusters=number_of_clusters,
...
def clustering_label_propagation():
    ...
    return render_template('cluster/clustering_label_propagation.html', example=df, number_of_clusters=number_of_clusters,
...
def clustering_spectral():
    ...
    multi_toggle=multi_toggle, dynamic_toggle=dynamic_toggle, directed_toggle=directed_toggle, layout=layout, graph1=graph_path1, method_name='Spectral')
