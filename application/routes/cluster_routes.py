...
def clustering_louvanian():
    ...
    return render_template('cluster/clustering_louvanian.html', session_id=filename2, clusterType=clusterType, method_name='Louvain')
...
def clustering_greedy_modularity():
    ...
    return render_template('cluster/clustering_greedy_modularity.html', session_id=filename2, clusterType=clusterType, method_name='Greedy Modularity')
...
def clustering_label_propagation():
    ...
    return render_template('cluster/clustering_label_propagation.html', session_id=filename2, clusterType=clusterType, method_name='Label Propagation')
...
def clustering_asyn_lpa():
    ...
    return render_template('cluster/clustering_asyn_lpa.html', session_id=filename2, clusterType=clusterType, method_name='Asyn Lpa')
...
def clustering_k_clique():
    ...
    return render_template('cluster/clustering_k_clique.html', session_id=filename2, clusterType=clusterType, method_name='K Clique')
...
def clustering_spectral():
    ...
    return render_template('cluster/clustering_spectral.html', session_id=filename2, clusterType=clusterType, method_name='Spectral')
...
def clustering_kmeans():
    ...
    return render_template('cluster/clustering_kmeans.html', session_id=filename2, clusterType=clusterType, method_name='KMeans')
...
def clustering_agglomerative():
    ...
    return render_template('cluster/clustering_agglomerative.html', session_id=filename2, clusterType=clusterType, method_name='Agglomerative')
...
def clustering_dbscan():
    ...
    return render_template('cluster/clustering_dbscan.html', session_id=filename2, clusterType=clusterType, method_name='Dbscan')
