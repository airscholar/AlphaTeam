...
def clustering_embedding_kmeans():
    ...
    tooltip_features=tooltips['features_checkbox'], tooltip_number_of_clusters=tooltips['number_of_clusters'])
...
def clustering_embedding_agglomerative():
    ...
    description=description['dlembedding_agglomerative'], tooltip_dimension=tooltips['dimension'], 
    tooltip_model_dropdown=tooltips['model_dropdown'], tooltip_layout=tooltips['layout_dropdown'], 
    tooltip_features=tooltips['features_checkbox'], tooltip_number_of_clusters=tooltips['number_of_clusters'])
