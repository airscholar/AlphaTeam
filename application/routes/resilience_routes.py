...
def resilience_analysis_malicious():
    ...
    #     networkGraphs2, df2 = resilience(networkGraphs, attack=attack, metric=layout,
    #                                      number_of_nodes=int(number_of_nodes_malicious))
    #
    # # here we use number of edges
    # if val2 != number_of_threshold:
    #     session['val2_malicious'] = number_of_threshold
    #     tab_main = 'tab2'
    #     session['tab_main'] = tab_main
    #     networkGraphs2, df2 = resilience(networkGraphs, attack=attack, metric=layout,
    ...
    #     tab_main = 'tab2'
    #     session['tab_main'] = tab_main
    #     if (number_of_threshold is not None):
    #         networkGraphs2, df2 = resilience(networkGraphs, attack=attack, metric=layout,
    #                                          threshold=int(number_of_threshold), operator=operator)
    ...
    #                                 number_of_threshold, number_of_cluster_to_generate,
    #                                 cluster_to_attack, null, layout2, layout3, tab_main, attack,
    #                                 number_of_nodes_malicious)
    ...
    #     number_of_threshold = session.get('number_of_threshold', None)
    #
    ...
    #             networkGraphs2, df2 = resilience(networkGraphs, attack=attack, cluster_algorithm=layout3,
    #                                              total_clusters=int(number_of_cluster_to_generate),
    #                                              number_of_clusters=int(cluster_to_attack))
    #
    ...
    #                                              number_of_clusters=int(cluster_to_attack))
    #
    #     return template_resilience_tabs('resilience/resilience_analyisis_cluster.html', number_of_nodes, number_of_edges,
    #                                     number_of_threshold, number_of_cluster_to_generate,
    ...
    #
    #     return template_resilience_tabs('resilience/resilience_analyisis_random.html', number_of_nodes, number_of_edges,
    #                                     number_of_threshold, number_of_cluster_to_generate,
    #                                     cluster_to_attack, layout, layout2, layout3, tab_main, attack,
    #                                     number_of_nodes_malicious)
    #
    #
    # @resilience_routes.route('/resilience/malicious/upload', endpoint='resilience_malicious_upload',
    #                          methods=['GET', 'POST'])
    ...
    #     session['number_of_threshold'] = number_of_threshold
    ...
    #
    #
    # def template_resilience_tabs(template_name_arg, attack_types, number_of_nodes_arg, number_of_edges_arg,
    #                              number_of_threshold_arg,
    #                              number_of_cluster_to_generate_arg, cluster_to_attack_arg,
    #                              layout_arg, layout2_arg, layout3_arg, tab_main_arg, attack_arg,
    #                              number_of_nodes_malicious_arg):
    #     filename2 = session['filename2']
    #     networkGraphs = get_networkGraph(filename2)
    #     multi_toggle = True
    ...
    #     graph_name1 = 'no_graph.html'
    #     graph_name2 = 'no_graph.html'
    ...
    #     # degree
    #     df_degree_centrality_before, graph_degree_centrality_layout_name_1 = plot_metric(networkGraphs,
    #                                                                                      'degree_centrality',
    #                                                                                      directed=directed_toggle,
    #                                                                                      multi=multi_toggle,
    #                                                                                      dynamic=False,
    #                                                                                      layout=visualisation_layout)
    #     df_degree_centrality_after, graph_degree_centrality_layout_name_2 = plot_metric(networkGraphs2,
    #                                                                                     'degree_centrality',
    #                                                                                     directed=directed_toggle,
    #                                                                                     multi=multi_toggle,
    #                                                                                     dynamic=False,
    #                                                                                     layout=visualisation_layout)
    #     df_degree_centrality_before, graph_degree_centrality_histogram_name_1 = plot_histogram(networkGraphs,
    #                                                                                            'degree_centrality',
    #                                                                                            directed=directed_toggle,
    #                                                                                            multi=multi_toggle)
    #     df_degree_centrality_after, graph_degree_centrality_histogram_name_2 = plot_histogram(networkGraphs2,
    #                                                                                           'degree_centrality',
    #                                                                                           directed=directed_toggle,
    #                                                                                           multi=multi_toggle)
    #     df_degree_centrality_before, graph_degree_centrality_boxplot_name_1 = plot_boxplot(networkGraphs,
    #                                                                                        'degree_centrality',
    #                                                                                        directed=directed_toggle,
    #                                                                                        multi=multi_toggle)
    #     df_degree_centrality_after, graph_degree_centrality_boxplot_name_2 = plot_boxplot(networkGraphs2,
    #                                                                                       'degree_centrality',
    #                                                                                       directed=directed_toggle,
    #                                                                                       multi=multi_toggle)
    #     df_degree_centrality_before, graph_degree_centrality_violinplot_name_1 = plot_violin(networkGraphs,
    #                                                                                          'degree_centrality',
    #                                                                                          directed=directed_toggle,
    #                                                                                          multi=multi_toggle)
    #     df_degree_centrality_after, graph_degree_centrality_violinplot_name_2 = plot_violin(networkGraphs2,
    #                                                                                         'degree_centrality',
    #                                                                                         directed=directed_toggle,
    #                                                                                         multi=multi_toggle)
    #     # enginevector
    #     df_eigenvector_centrality_before, graph_eigenvector_centrality_layout_name_1 = plot_metric(networkGraphs,
    #                                                                                                'eigenvector_centrality',
    #                                                                                                directed=directed_toggle,
    #                                                                                                multi=multi_toggle,
    #                                                                                                dynamic=False,
    #                                                                                                layout=visualisation_layout)
    #     df_eigenvector_centrality_after, graph_eigenvector_centrality_layout_name_2 = plot_metric(networkGraphs2,
    #                                                                                               'eigenvector_centrality',
    #                                                                                               directed=directed_toggle,
    #                                                                                               multi=multi_toggle,
    #                                                                                               dynamic=False,
    #                                                                                               layout=visualisation_layout)
    #     df_eigenvector_centrality_before, graph_eigenvector_centrality_histogram_name_1 = plot_histogram(networkGraphs,
    #                                                                                                      'eigenvector_centrality',
    #                                                                                                      directed=directed_toggle,
    #                                                                                                      multi=multi_toggle)
    #     df_eigenvector_centrality_after, graph_eigenvector_centrality_histogram_name_2 = plot_histogram(networkGraphs2,
    #                                                                                                     'eigenvector_centrality',
    #                                                                                                     directed=directed_toggle,
    #                                                                                                     multi=multi_toggle)
    #     df_eigenvector_centrality_before, graph_eigenvector_centrality_boxplot_name_1 = plot_boxplot(networkGraphs,
    #                                                                                                  'eigenvector_centrality',
    #                                                                                                  directed=directed_toggle,
    #                                                                                                  multi=multi_toggle)
    #     df_eigenvector_centrality_after, graph_eigenvector_centrality_boxplot_name_2 = plot_boxplot(networkGraphs2,
    #                                                                                                 'eigenvector_centrality',
    #                                                                                                 directed=directed_toggle,
    #                                                                                                 multi=multi_toggle)
    #     df_eigenvector_centrality_before, graph_eigenvector_centrality_violinplot_name_1 = plot_violin(networkGraphs,
    #                                                                                                    'eigenvector_centrality',
    #                                                                                                    directed=directed_toggle,
    #                                                                                                    multi=multi_toggle)
    #     df_eigenvector_centrality_after, graph_eigenvector_centrality_violinplot_name_2 = plot_violin(networkGraphs2,
    #                                                                                                   'eigenvector_centrality',
    #                                                                                                   directed=directed_toggle,
    #                                                                                                   multi=multi_toggle)
    #     # closeness
    #     df_closeness_centrality_before, graph_closeness_centrality_layout_name_1 = plot_metric(networkGraphs,
    #                                                                                            'closeness_centrality',
    #                                                                                            directed=directed_toggle,
    #                                                                                            multi=multi_toggle,
    #                                                                                            dynamic=False,
    #                                                                                            layout=visualisation_layout)
    #     df_closeness_centrality_after, graph_closeness_centrality_layout_name_2 = plot_metric(networkGraphs2,
    #                                                                                           'closeness_centrality',
    #                                                                                           directed=directed_toggle,
    #                                                                                           multi=multi_toggle,
    #                                                                                           dynamic=False,
    #                                                                                           layout=visualisation_layout)
    #     df_closeness_centrality_before, graph_closeness_centrality_histogram_name_1 = plot_histogram(networkGraphs,
    #                                                                                                  'closeness_centrality',
    #                                                                                                  directed=directed_toggle,
    #                                                                                                  multi=multi_toggle)
    #     df_closeness_centrality_after, graph_closeness_centrality_histogram_name_2 = plot_histogram(networkGraphs2,
    #                                                                                                 'closeness_centrality',
    #                                                                                                 directed=directed_toggle,
    #                                                                                                 multi=multi_toggle)
    #     df_closeness_centrality_before, graph_closeness_centrality_boxplot_name_1 = plot_boxplot(networkGraphs,
    #                                                                                              'closeness_centrality',
    #                                                                                              directed=directed_toggle,
    #                                                                                              multi=multi_toggle)
    #     df_closeness_centrality_after, graph_closeness_centrality_boxplot_name_2 = plot_boxplot(networkGraphs2,
    #                                                                                             'closeness_centrality',
    #                                                                                             directed=directed_toggle,
    #                                                                                             multi=multi_toggle)
    #     df_closeness_centrality_before, graph_closeness_centrality_violinplot_name_1 = plot_violin(networkGraphs,
    #                                                                                                'closeness_centrality',
    #                                                                                                directed=directed_toggle,
    #                                                                                                multi=multi_toggle)
    #     df_closeness_centrality_after, graph_closeness_centrality_violinplot_name_2 = plot_violin(networkGraphs2,
    #                                                                                               'closeness_centrality',
    #                                                                                               directed=directed_toggle,
    #                                                                                               multi=multi_toggle)
    #     # betweness
    #     df_betwenness_centrality_before, graph_betwenness_centrality_layout_name_1 = plot_metric(networkGraphs,
    #                                                                                              'betweenness_centrality',
    #                                                                                              directed=directed_toggle,
    #                                                                                              multi=multi_toggle,
    #                                                                                              dynamic=False,
    #                                                                                              layout=visualisation_layout)
    #     df_betwenness_centrality_after, graph_betwenness_centrality_layout_name_2 = plot_metric(networkGraphs2,
    #                                                                                             'betweenness_centrality',
    #                                                                                             directed=directed_toggle,
    #                                                                                             multi=multi_toggle,
    #                                                                                             dynamic=False,
    #                                                                                             layout=visualisation_layout)
    #     df_betwenness_centrality_before, graph_betwenness_centrality_histogram_name_1 = plot_histogram(networkGraphs,
    #                                                                                                    'betweenness_centrality',
    #                                                                                                    directed=directed_toggle,
    #                                                                                                    multi=multi_toggle)
    #     df_betwenness_centrality_after, graph_betwenness_centrality_histogram_name_2 = plot_histogram(networkGraphs2,
    #                                                                                                   'betweenness_centrality',
    #                                                                                                   directed=directed_toggle,
    #                                                                                                   multi=multi_toggle)
    #     df_betwenness_centrality_before, graph_betwenness_centrality_boxplot_name_1 = plot_boxplot(networkGraphs,
    #                                                                                                'betweenness_centrality',
    #                                                                                                directed=directed_toggle,
    #                                                                                                multi=multi_toggle)
    #     df_betwenness_centrality_after, graph_betwenness_centrality_boxplot_name_2 = plot_boxplot(networkGraphs2,
    #                                                                                               'betweenness_centrality',
    #                                                                                               directed=directed_toggle,
    #                                                                                               multi=multi_toggle)
    #     df_betwenness_centrality_before, graph_betwenness_centrality_violinplot_name_1 = plot_violin(networkGraphs,
    #                                                                                                  'betweenness_centrality',
    #                                                                                                  directed=directed_toggle,
    #                                                                                                  multi=multi_toggle)
    #     df_betwenness_centrality_after, graph_betwenness_centrality_violinplot_name_2 = plot_violin(networkGraphs2,
    #                                                                                                 'betweenness_centrality',
    #                                                                                                 directed=directed_toggle,
    #                                                                                                 multi=multi_toggle)
    #     # load
    #     df_load_centrality_before, graph_load_centrality_layout_name_1 = plot_metric(networkGraphs, 'load_centrality',
    #                                                                                  directed=directed_toggle,
    #                                                                                  multi=multi_toggle, dynamic=False,
    #                                                                                  layout=visualisation_layout)
    #     df_load_centrality_after, graph_load_centrality_layout_name_2 = plot_metric(networkGraphs2, 'load_centrality',
    #                                                                                 directed=directed_toggle,
    #                                                                                 multi=multi_toggle, dynamic=False,
    #                                                                                 layout=visualisation_layout)
    #     df_load_centrality_before, graph_load_centrality_histogram_name_1 = plot_histogram(networkGraphs,
    #                                                                                        'load_centrality',
    #                                                                                        directed=directed_toggle,
    #                                                                                        multi=multi_toggle)
    #     df_load_centrality_after, graph_load_centrality_histogram_name_2 = plot_histogram(networkGraphs2,
    #                                                                                       'load_centrality',
    #                                                                                       directed=directed_toggle,
    #                                                                                       multi=multi_toggle)
    #     df_load_centrality_before, graph_load_centrality_boxplot_name_1 = plot_boxplot(networkGraphs, 'load_centrality',
    #                                                                                    directed=directed_toggle,
    #                                                                                    multi=multi_toggle)
    #     df_load_centrality_after, graph_load_centrality_boxplot_name_2 = plot_boxplot(networkGraphs2, 'load_centrality',
    #                                                                                   directed=directed_toggle,
    #                                                                                   multi=multi_toggle)
    #     df_load_centrality_before, graph_load_centrality_violinplot_name_1 = plot_violin(networkGraphs,
    #                                                                                      'load_centrality',
    #                                                                                      directed=directed_toggle,
    #                                                                                      multi=multi_toggle)
    #     df_load_centrality_after, graph_load_centrality_violinplot_name_2 = plot_violin(networkGraphs2,
    #                                                                                     'load_centrality',
    #                                                                                     directed=directed_toggle,
    #                                                                                     multi=multi_toggle)
    #     # kcore
    #     df_kcore_node_before, graph_kcore_node_layout_name_1 = plot_metric(networkGraphs, 'kcore',
    #                                                                        directed=directed_toggle, multi=multi_toggle,
    #                                                                        dynamic=False, layout=visualisation_layout)
    #     df_kcore_node_after, graph_kcore_node_layout_name_2 = plot_metric(networkGraphs2, 'kcore',
    #                                                                       directed=directed_toggle, multi=multi_toggle,
    #                                                                       dynamic=False, layout=visualisation_layout)
    #     df_kcore_node_before, graph_kcore_node_histogram_name_1 = plot_histogram(networkGraphs, 'kcore',
    #                                                                              directed=directed_toggle,
    #                                                                              multi=multi_toggle)
    #     df_kcore_node_after, graph_kcore_node_histogram_name_2 = plot_histogram(networkGraphs2, 'kcore',
    #                                                                             directed=directed_toggle,
    #                                                                             multi=multi_toggle)
    #     df_kcore_node_before, graph_kcore_node_boxplot_name_1 = plot_boxplot(networkGraphs, 'kcore',
    #                                                                          directed=directed_toggle,
    #                                                                          multi=multi_toggle)
    #     df_kcore_node_after, graph_kcore_node_boxplot_name_2 = plot_boxplot(networkGraphs2, 'kcore',
    #                                                                         directed=directed_toggle,
    #                                                                         multi=multi_toggle)
    #     df_kcore_node_before, graph_kcore_node_violinplot_name_1 = plot_violin(networkGraphs, 'kcore',
    #                                                                            directed=directed_toggle,
    #                                                                            multi=multi_toggle)
    #     df_kcore_node_after, graph_kcore_node_violinplot_name_2 = plot_violin(networkGraphs2, 'kcore',
    #                                                                           directed=directed_toggle,
    #                                                                           multi=multi_toggle)
    #     # degree
    #     df_degree_node_before, graph_degree_node_layout_name_1 = plot_metric(networkGraphs, 'degree',
    #                                                                          directed=directed_toggle,
    #                                                                          multi=multi_toggle, dynamic=False,
    #                                                                          layout=visualisation_layout)
    #     df_degree_node_after, graph_degree_node_layout_name_2 = plot_metric(networkGraphs2, 'degree',
    #                                                                         directed=directed_toggle,
    #                                                                         multi=multi_toggle, dynamic=False,
    #                                                                         layout=visualisation_layout)
    #     df_degree_node_before, graph_degree_node_histogram_name_1 = plot_histogram(networkGraphs, 'degree',
    #                                                                                directed=directed_toggle,
    #                                                                                multi=multi_toggle)
    #     df_degree_node_after, graph_degree_node_histogram_name_2 = plot_histogram(networkGraphs2, 'degree',
    #                                                                               directed=directed_toggle,
    #                                                                               multi=multi_toggle)
    #     df_degree_node_before, graph_degree_node_boxplot_name_1 = plot_boxplot(networkGraphs, 'degree',
    #                                                                            directed=directed_toggle,
    #                                                                            multi=multi_toggle)
    #     df_degree_node_after, graph_degree_node_boxplot_name_2 = plot_boxplot(networkGraphs2, 'degree',
    #                                                                           directed=directed_toggle,
    #                                                                           multi=multi_toggle)
    #     df_degree_node_before, graph_degree_node_violinplot_name_1 = plot_violin(networkGraphs, 'degree',
    #                                                                              directed=directed_toggle,
    #                                                                              multi=multi_toggle)
    #     df_degree_node_after, graph_degree_node_violinplot_name_2 = plot_violin(networkGraphs2, 'degree',
    #                                                                             directed=directed_toggle,
    #                                                                             multi=multi_toggle)
    #     # triangles
    #     df_triangles_node_before, graph_triangles_node_layout_name_1 = plot_metric(networkGraphs, 'triangles',
    #                                                                                directed=directed_toggle,
    #                                                                                multi=multi_toggle, dynamic=False,
    #                                                                                layout=visualisation_layout)
    #     df_triangles_node_after, graph_triangles_node_layout_name_2 = plot_metric(networkGraphs2, 'triangles',
    #                                                                               directed=directed_toggle,
    #                                                                               multi=multi_toggle, dynamic=False,
    #                                                                               layout=visualisation_layout)
    #     df_triangles_node_before, graph_triangles_node_histogram_name_1 = plot_histogram(networkGraphs, 'triangles',
    #                                                                                      directed=directed_toggle,
    #                                                                                      multi=multi_toggle)
    #     df_triangles_node_after, graph_triangles_node_histogram_name_2 = plot_histogram(networkGraphs2, 'triangles',
    #                                                                                     directed=directed_toggle,
    #                                                                                     multi=multi_toggle)
    #     df_triangles_node_before, graph_triangles_node_boxplot_name_1 = plot_boxplot(networkGraphs, 'triangles',
    #                                                                                  directed=directed_toggle,
    #                                                                                  multi=multi_toggle)
    #     df_triangles_node_after, graph_triangles_node_boxplot_name_2 = plot_boxplot(networkGraphs2, 'triangles',
    #                                                                                 directed=directed_toggle,
    #                                                                                 multi=multi_toggle)
    #     df_triangles_node_before, graph_triangles_node_violinplot_name_1 = plot_violin(networkGraphs, 'triangles',
    #                                                                                    directed=directed_toggle,
    #                                                                                    multi=multi_toggle)
    #     df_triangles_node_after, graph_triangles_node_violinplot_name_2 = plot_violin(networkGraphs2, 'triangles',
    #                                                                                   directed=directed_toggle,
    #                                                                                   multi=multi_toggle)
    #     # pagerank
    #     df_pagerank_node_before, graph_pagerank_node_layout_name_1 = plot_metric(networkGraphs, 'pagerank',
    #                                                                              directed=directed_toggle,
    #                                                                              multi=multi_toggle, dynamic=False,
    #                                                                              layout=visualisation_layout)
    #     df_pagerank_node_after, graph_pagerank_node_layout_name_2 = plot_metric(networkGraphs2, 'pagerank',
    #                                                                             directed=directed_toggle,
    #                                                                             multi=multi_toggle, dynamic=False,
    #                                                                             layout=visualisation_layout)
    #     df_pagerank_node_before, graph_pagerank_node_histogram_name_1 = plot_histogram(networkGraphs, 'pagerank',
    #                                                                                    directed=directed_toggle,
    #                                                                                    multi=multi_toggle)
    #     df_pagerank_node_after, graph_pagerank_node_histogram_name_2 = plot_histogram(networkGraphs2, 'pagerank',
    #                                                                                   directed=directed_toggle,
    #                                                                                   multi=multi_toggle)
    #     df_pagerank_node_before, graph_pagerank_node_boxplot_name_1 = plot_boxplot(networkGraphs, 'pagerank',
    #                                                                                directed=directed_toggle,
    #                                                                                multi=multi_toggle)
    #     df_pagerank_node_after, graph_pagerank_node_boxplot_name_2 = plot_boxplot(networkGraphs2, 'pagerank',
    #                                                                               directed=directed_toggle,
    #                                                                               multi=multi_toggle)
    #     df_pagerank_node_before, graph_pagerank_node_violinplot_name_1 = plot_violin(networkGraphs, 'pagerank',
    #                                                                                  directed=directed_toggle,
    #                                                                                  multi=multi_toggle)
    #     df_pagerank_node_after, graph_pagerank_node_violinplot_name_2 = plot_violin(networkGraphs2, 'pagerank',
    #                                                                                 directed=directed_toggle,
    #                                                                                 multi=multi_toggle)
    #
    #     # clusters seperate condition
    #     if number_of_clusters is not None:
    #         df_louvain_before, graph_louvain_name_1 = plot_cluster(networkGraphs, 'louvain',
    #                                                                noOfClusters=number_of_clusters, dynamic=False,
    #                                                                layout=visualisation_layout)
    #         df_louvain_after, graph_louvain_name_2 = plot_cluster(networkGraphs2, 'louvain',
    #                                                               noOfClusters=number_of_clusters, dynamic=False,
    #                                                               layout=visualisation_layout)
    #         df_greedy_modularity_before, graph_greedy_modularity_name_1 = plot_cluster(networkGraphs,
    #                                                                                    'greedy_modularity',
    #                                                                                    noOfClusters=number_of_clusters,
    #                                                                                    dynamic=False,
    #                                                                                    layout=visualisation_layout)
    #         df_greedy_modularity_after, graph_greedy_modularity_name_2 = plot_cluster(networkGraphs2,
    #                                                                                   'greedy_modularity',
    #                                                                                   noOfClusters=number_of_clusters,
    #                                                                                   dynamic=False,
    #                                                                                   layout=visualisation_layout)
    #         df_label_propagation_before, graph_label_propagation_name_1 = plot_cluster(networkGraphs,
    #                                                                                    'label_propagation',
    #                                                                                    noOfClusters=number_of_clusters,
    #                                                                                    dynamic=False,
    #                                                                                    layout=visualisation_layout)
    #         df_label_propagation_after, graph_label_propagation_name_2 = plot_cluster(networkGraphs2,
    #                                                                                   'label_propagation',
    #                                                                                   noOfClusters=number_of_clusters,
    #                                                                                   dynamic=False,
    #                                                                                   layout=visualisation_layout)
    #         df_asyn_lpa_before, graph_asyn_lpa_name_1 = plot_cluster(networkGraphs, 'asyn_lpa',
    #                                                                  noOfClusters=number_of_clusters, dynamic=False,
    #                                                                  layout=visualisation_layout)
    #         df_asyn_lpa_after, graph_asyn_lpa_name_2 = plot_cluster(networkGraphs2, 'asyn_lpa',
    #                                                                 noOfClusters=number_of_clusters, dynamic=False,
    #                                                                 layout=visualisation_layout)
    #         df_k_clique_before, graph_k_clique_name_1 = plot_cluster(networkGraphs, 'k_clique',
    #                                                                  noOfClusters=number_of_clusters, dynamic=False,
    #                                                                  layout=visualisation_layout)
    #         df_k_clique_after, graph_k_clique_name_2 = plot_cluster(networkGraphs2, 'k_clique',
    #                                                                 noOfClusters=number_of_clusters, dynamic=False,
    #                                                                 layout=visualisation_layout)
    #         df_spectral_before, graph_spectral_name_1 = plot_cluster(networkGraphs, 'spectral',
    #                                                                  noOfClusters=number_of_clusters, dynamic=False,
    #                                                                  layout=visualisation_layout)
    #         df_spectral_after, graph_spectral_name_2 = plot_cluster(networkGraphs2, 'spectral',
    #                                                                 noOfClusters=number_of_clusters, dynamic=False,
    #                                                                 layout=visualisation_layout)
    #         df_kmeans_before, graph_kmeans_name_1 = plot_cluster(networkGraphs, 'kmeans',
    #                                                              noOfClusters=number_of_clusters, dynamic=False,
    #                                                              layout=visualisation_layout)
    #         df_kmeans_after, graph_kmeans_name_2 = plot_cluster(networkGraphs2, 'kmeans',
    #                                                             noOfClusters=number_of_clusters, dynamic=False,
    #                                                             layout=visualisation_layout)
    #         df_agglomerative_before, graph_agglomerative_name_1 = plot_cluster(networkGraphs, 'agglomerative',
    #                                                                            noOfClusters=number_of_clusters,
    #                                                                            dynamic=False,
    #                                                                            layout=visualisation_layout)
    #         df_agglomerative_after, graph_agglomerative_name_2 = plot_cluster(networkGraphs2, 'agglomerative',
    #                                                                           noOfClusters=number_of_clusters,
    #                                                                           dynamic=False,
    #                                                                           layout=visualisation_layout)
    #         df_dbscan_before, graph_dbscan_name_1 = plot_cluster(networkGraphs, 'dbscan',
    #                                                              noOfClusters=number_of_clusters, dynamic=False,
    #                                                              layout=visualisation_layout)
    #         df_dbscan_after, graph_dbscan_name_2 = plot_cluster(networkGraphs2, 'dbscan',
    #                                                             noOfClusters=number_of_clusters, dynamic=False,
    #                                                             layout=visualisation_layout)
    #     else:
    #         df_louvain_before, graph_louvain_name_1 = plot_cluster(networkGraphs, 'louvain', noOfClusters=0,
    #                                                                dynamic=False, layout=visualisation_layout)
    #         df_louvain_after, graph_louvain_name_2 = plot_cluster(networkGraphs2, 'louvain', noOfClusters=0,
    #                                                               dynamic=False, layout=visualisation_layout)
    #         df_greedy_modularity_before, graph_greedy_modularity_name_1 = plot_cluster(networkGraphs,
    #                                                                                    'greedy_modularity',
    #                                                                                    noOfClusters=0, dynamic=False,
    #                                                                                    layout=visualisation_layout)
    #         df_greedy_modularity_after, graph_greedy_modularity_name_2 = plot_cluster(networkGraphs2,
    #                                                                                   'greedy_modularity',
    #                                                                                   noOfClusters=0, dynamic=False,
    ...
    #                                                                                   noOfClusters=0, dynamic=False,
    #                                                                                   layout=visualisation_layout)
    #         df_asyn_lpa_before, graph_asyn_lpa_name_1 = plot_cluster(networkGraphs, 'asyn_lpa', noOfClusters=0,
    #                                                                  dynamic=False, layout=visualisation_layout)
    #         df_asyn_lpa_after, graph_asyn_lpa_name_2 = plot_cluster(networkGraphs2, 'asyn_lpa', noOfClusters=0,
    #                                                                 dynamic=False, layout=visualisation_layout)
    #         df_k_clique_before, graph_k_clique_name_1 = plot_cluster(networkGraphs, 'k_clique', noOfClusters=0,
    #                                                                  dynamic=False, layout=visualisation_layout)
    #         df_k_clique_after, graph_k_clique_name_2 = plot_cluster(networkGraphs2, 'k_clique', noOfClusters=0,
    #                                                                 dynamic=False, layout=visualisation_layout)
    #         df_spectral_before, graph_spectral_name_1 = plot_cluster(networkGraphs, 'spectral', noOfClusters=0,
    #                                                                  dynamic=False, layout=visualisation_layout)
    #         df_spectral_after, graph_spectral_name_2 = plot_cluster(networkGraphs2, 'spectral', noOfClusters=0,
    #                                                                 dynamic=False, layout=visualisation_layout)
    #         df_kmeans_before, graph_kmeans_name_1 = plot_cluster(networkGraphs, 'kmeans', noOfClusters=0, dynamic=False,
    #                                                              layout=visualisation_layout)
    #         df_kmeans_after, graph_kmeans_name_2 = plot_cluster(networkGraphs2, 'kmeans', noOfClusters=0, dynamic=False,
    #                                                             layout=visualisation_layout)
    #         df_agglomerative_before, graph_agglomerative_name_1 = plot_cluster(networkGraphs, 'agglomerative',
    #                                                                            noOfClusters=0, dynamic=False,
    #                                                                            layout=visualisation_layout)
    ...
    #                                                                           noOfClusters=0, dynamic=False,
    #                                                                           layout=visualisation_layout)
    #         df_dbscan_before, graph_dbscan_name_1 = plot_cluster(networkGraphs, 'dbscan', noOfClusters=0, dynamic=False,
    #                                                              layout=visualisation_layout)
    #         df_dbscan_after, graph_dbscan_name_2 = plot_cluster(networkGraphs2, 'dbscan', noOfClusters=0, dynamic=False,
    #                                                             layout=visualisation_layout)
    #     # end POST condition
    #
    ...
    return render_template(template_name_arg, attack_types=attack_types, tab_main=tab_main_arg,
                           visualisation_layout=visualisation_layout,
                           number_of_threshold=number_of_threshold_arg,
                           number_of_nodes=number_of_nodes_arg, number_of_edges=number_of_edges_arg, graph1=graph_path1,
                           graph2=graph_path2, layout=layout_arg, layout2=layout2_arg,
                           multi_toggle=multi_toggle, directed_toggle=directed_toggle,
                           number_of_clusters=number_of_clusters,
                           number_of_cluster_to_generate=number_of_cluster_to_generate_arg,
                           cluster_to_attack=cluster_to_attack_arg, layout3_arg=layout3_arg,
                           number_of_nodes_malicious=number_of_nodes_malicious_arg,
                           # df_degree_centrality_before=df_degree_centrality_before,
                           # df_degree_centrality_after=df_degree_centrality_after,
                           # graph_degree_centrality_layout_1=graph_degree_centrality_layout_path_1,
                           # graph_degree_centrality_layout_2=graph_degree_centrality_layout_path_2,
                           # graph_degree_centrality_histogram_1=graph_degree_centrality_histogram_path_1,
                           # graph_degree_centrality_histogram_2=graph_degree_centrality_histogram_path_2,
                           # graph_degree_centrality_boxplot_1=graph_degree_centrality_boxplot_path_1,
                           # graph_degree_centrality_boxplot_2=graph_degree_centrality_boxplot_path_2,
                           # graph_degree_centrality_violinplot_1=graph_degree_centrality_violinplot_path_1,
                           # graph_degree_centrality_violinplot_2=graph_degree_centrality_violinplot_path_2,
                           #
                           # df_eigenvector_centrality_before=df_eigenvector_centrality_before,
                           # df_eigenvector_centrality_after=df_eigenvector_centrality_after,
                           # graph_eigenvector_centrality_layout_1=graph_eigenvector_centrality_layout_path_1,
                           # graph_eigenvector_centrality_layout_2=graph_eigenvector_centrality_layout_path_2,
                           # graph_eigenvector_centrality_histogram_1=graph_eigenvector_centrality_histogram_path_1,
                           # graph_eigenvector_centrality_histogram_2=graph_eigenvector_centrality_histogram_path_2,
                           # graph_eigenvector_centrality_boxplot_1=graph_eigenvector_centrality_boxplot_path_1,
                           # graph_eigenvector_centrality_boxplot_2=graph_eigenvector_centrality_boxplot_path_2,
                           # graph_eigenvector_centrality_violinplot_1=graph_eigenvector_centrality_violinplot_path_1,
                           # graph_eigenvector_centrality_violinplot_2=graph_eigenvector_centrality_violinplot_path_2,
                           #
                           # df_closeness_centrality_before=df_closeness_centrality_before,
                           # df_closeness_centrality_after=df_closeness_centrality_after,
                           # graph_closeness_centrality_layout_1=graph_closeness_centrality_layout_path_1,
                           # graph_closeness_centrality_layout_2=graph_closeness_centrality_layout_path_2,
                           # graph_closeness_centrality_histogram_1=graph_closeness_centrality_histogram_path_1,
                           # graph_closeness_centrality_histogram_2=graph_closeness_centrality_histogram_path_2,
                           # graph_closeness_centrality_boxplot_1=graph_closeness_centrality_boxplot_path_1,
                           # graph_closeness_centrality_boxplot_2=graph_closeness_centrality_boxplot_path_2,
                           # graph_closeness_centrality_violinplot_1=graph_closeness_centrality_violinplot_path_1,
                           # graph_closeness_centrality_violinplot_2=graph_closeness_centrality_violinplot_path_2,
                           #
                           # df_betwenness_centrality_before=df_betwenness_centrality_before,
                           # df_betwenness_centrality_after=df_betwenness_centrality_after,
                           # graph_betwenness_centrality_layout_1=graph_betwenness_centrality_layout_path_1,
                           # graph_betwenness_centrality_layout_2=graph_betwenness_centrality_layout_path_2,
                           # graph_betwenness_centrality_histogram_1=graph_betwenness_centrality_histogram_path_1,
                           # graph_betwenness_centrality_histogram_2=graph_betwenness_centrality_histogram_path_2,
                           # graph_betwenness_centrality_boxplot_1=graph_betwenness_centrality_boxplot_path_1,
                           # graph_betwenness_centrality_boxplot_2=graph_betwenness_centrality_boxplot_path_2,
                           # graph_betwenness_centrality_violinplot_1=graph_betwenness_centrality_violinplot_path_1,
                           # graph_betwenness_centrality_violinplot_2=graph_betwenness_centrality_violinplot_path_2,
                           #
                           # df_load_centrality_before=df_load_centrality_before,
                           # df_load_centrality_after=df_load_centrality_after,
                           # graph_load_centrality_layout_1=graph_load_centrality_layout_path_1,
                           # graph_load_centrality_layout_2=graph_load_centrality_layout_path_2,
                           # graph_load_centrality_histogram_1=graph_load_centrality_histogram_path_1,
                           # graph_load_centrality_histogram_2=graph_load_centrality_histogram_path_2,
                           # graph_load_centrality_boxplot_1=graph_load_centrality_boxplot_path_1,
                           # graph_load_centrality_boxplot_2=graph_load_centrality_boxplot_path_2,
                           # graph_load_centrality_violinplot_1=graph_load_centrality_violinplot_path_1,
                           # graph_load_centrality_violinplot_2=graph_load_centrality_violinplot_path_2,
                           #
                           # df_kcore_node_before=df_kcore_node_before, df_kcore_node_after=df_kcore_node_after,
                           # graph_kcore_node_layout_1=graph_kcore_node_layout_path_1,
                           # graph_kcore_node_layout_2=graph_kcore_node_layout_path_2,
                           # graph_kcore_node_histogram_1=graph_kcore_node_histogram_path_1,
                           # graph_kcore_node_histogram_2=graph_kcore_node_histogram_path_2,
                           # graph_kcore_node_boxplot_1=graph_kcore_node_boxplot_path_1,
                           # graph_kcore_node_boxplot_2=graph_kcore_node_boxplot_path_2,
                           # graph_kcore_node_violinplot_1=graph_kcore_node_violinplot_path_1,
                           # graph_kcore_node_violinplot_2=graph_kcore_node_violinplot_path_2,
                           #
                           # df_degree_node_before=df_degree_node_before, df_degree_node_after=df_degree_node_after,
                           # graph_degree_node_layout_1=graph_degree_node_layout_path_1,
                           # graph_degree_node_layout_2=graph_degree_node_layout_path_2,
                           # graph_degree_node_histogram_1=graph_degree_node_histogram_path_1,
                           # graph_degree_node_histogram_2=graph_degree_node_histogram_path_2,
                           # graph_degree_node_boxplot_1=graph_degree_node_boxplot_path_1,
                           # graph_degree_node_boxplot_2=graph_degree_node_boxplot_path_2,
                           # graph_degree_node_violinplot_1=graph_degree_node_violinplot_path_1,
                           # graph_degree_node_violinplot_2=graph_degree_node_violinplot_path_2,
                           #
                           # df_triangles_node_before=df_triangles_node_before,
                           # df_triangles_node_after=df_triangles_node_after,
                           # graph_triangles_node_layout_1=graph_triangles_node_layout_path_1,
                           # graph_triangles_node_layout_2=graph_triangles_node_layout_path_2,
                           # graph_triangles_node_histogram_1=graph_triangles_node_histogram_path_1,
                           # graph_triangles_node_histogram_2=graph_triangles_node_histogram_path_2,
                           # graph_triangles_node_boxplot_1=graph_triangles_node_boxplot_path_1,
                           # graph_triangles_node_boxplot_2=graph_triangles_node_boxplot_path_2,
                           # graph_triangles_node_violinplot_1=graph_triangles_node_violinplot_path_1,
                           # graph_triangles_node_violinplot_2=graph_triangles_node_violinplot_path_2,
                           #
                           # df_pagerank_node_before=df_pagerank_node_before,
                           # df_pagerank_node_after=df_pagerank_node_after,
                           # graph_pagerank_node_layout_1=graph_pagerank_node_layout_path_1,
                           # graph_pagerank_node_layout_2=graph_pagerank_node_layout_path_2,
                           # graph_pagerank_node_histogram_1=graph_pagerank_node_histogram_path_1,
                           # graph_pagerank_node_histogram_2=graph_pagerank_node_histogram_path_2,
                           # graph_pagerank_node_boxplot_1=graph_pagerank_node_boxplot_path_1,
                           # graph_pagerank_node_boxplot_2=graph_pagerank_node_boxplot_path_2,
                           # graph_pagerank_node_violinplot_1=graph_pagerank_node_violinplot_path_1,
                           # graph_pagerank_node_violinplot_2=graph_pagerank_node_violinplot_path_2,
                           #
                           ...
                           #
                           # df_greedy_modularity_before=df_greedy_modularity_before,
                           # df_greedy_modularity_after=df_greedy_modularity_after,
                           # graph_greedy_modularity_1=graph_greedy_modularity_path_1,
                           # graph_greedy_modularity_2=graph_greedy_modularity_path_2,
                           #
                           # df_label_propagation_before=df_label_propagation_before,
                           # df_label_propagation_after=df_label_propagation_after,
                           # graph_label_propagation_1=graph_label_propagation_path_1,
                           # graph_label_propagation_2=graph_label_propagation_path_2,
                           #
                           ...
                           #
                           # df_agglomerative_before=df_agglomerative_before,
                           # df_agglomerative_after=df_agglomerative_after,
                           # graph_agglomerative_1=graph_agglomerative_path_1,
                           # graph_agglomerative_2=graph_agglomerative_path_2,
                           #
